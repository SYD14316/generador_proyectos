            ...
            foreach ($datos_busqueda as $registro) {
              ...
              //Defino la sentencia para actualizar al colaborador
                $sentencia="
                  ...
                  INSERT INTO bitacora (fecha,hora,accion,usuario) VALUES ('".ahora(1)."','".ahora(2)."','SE CAMBIA AL NIVEL CERO AL USUARIO CLAVE $clave',$clave_usr);
                ";
              //Ejecuto la actualizacion de los menu's
                ...
                if ($devuelto==true) {
                  echo "
                    <script>
                      alert('¡ACTUALIZADO!, COLABORADOR $clave DEGRADADO');
                    </script>
                  ";
                }
              //
