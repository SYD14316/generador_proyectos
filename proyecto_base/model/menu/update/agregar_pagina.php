            ...
            foreach ($datos_busqueda as $registro) {
              ...
              //Defino la sentencia para actualizar al colaborador
                $sentencia="
                  ...
                  INSERT INTO bitacora (fecha,hora,accion,usuario) VALUES ('".ahora(1)."','".ahora(2)."','SE LE ASIGNA EL MENÚ N° $id_pagina AL USUARIO CLAVE $clave COMO PAGINA PRINCIPAL',$clave_usr);
                ";
